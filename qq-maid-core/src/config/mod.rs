...
pub const DEFAULT_TOOL_CALLING_MAX_ROUNDS: u64 = 3; // 原生 Tool Calling 最大工具轮数
pub const DEFAULT_AGENT_CONTEXT_CHAR_LIMIT: u64 = 120_000; // 本地上下文窗口字符预算
...
impl AppConfig {
    ...
    pub fn from_env() -> Result<Self, LlmError> {
        ...
        let tool_result_max_chars = env_u64_bounded(
