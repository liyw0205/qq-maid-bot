...
<p align="center">
  <img src="docs/img/1782674925207..png" alt="QQ 聊天效果" width="42%" />
  <img src="docs/img/1782674938137..png" alt="botctl 终端效果" width="42%" />
</p>
...
最少需要填写：`QQ_BOT_APP_ID`、`QQ_BOT_APP_SECRET`、模型 API Key 和 Base URL。
...
# 首次构建可能需要 Visual Studio Build Tools（C++ 构建工具）
cd runtime
